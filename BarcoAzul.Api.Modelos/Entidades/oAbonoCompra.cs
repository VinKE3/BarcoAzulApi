...
{
    public class oAbonoCompra : IValidatableObject
    {
        public string Id => $"{EmpresaId}{ProveedorId}{TipoDocumentoId}{Serie}{Numero}";
        ...
        public string DocumentoCompraId { get; set; }
        ...
        {
            if (TipoPagoId == "CH" || TipoPagoId == "DE" || TipoPagoId == "TR")
            {
